...
'coordinates': [-114.045827, 51.045071]
...
},
  {
    ...
    'geometry': {
    'type': 'Point',
    'coordinates': [-114.101669, 51.028269]
    }
  },
  {
    'type': 'Feature',
    ...
    'geometry': {
    'type': 'Point',
    'coordinates': [-114.097033, 51.044771]
    }
  },
...
var geojson = {
    ...
    },
    {
      ...
      properties: {
        ...
        vaccine: 'Vaccine Requirement:',
        mask: "Mask Requirement:",
        Website: 'Register at www.redcross.ca'
      },
    },
    {
      type: 'Feature',
      ...
      properties: {
        title: "Lime Electric Scooter Rental",
        Attendance: "$15/hour",
        vaccine: 'Vaccine Requirement:',
        mask: "Mask Requirement:",
        Website: 'Sign up at www.li.me'
      },
    },
...
map.on('load', function () {
  ...
  alert("This page is for future use when people are allowed to travel and be outside again (hopefully this summer). This site will give you local and international guides and data to help you make an informed decision.");
